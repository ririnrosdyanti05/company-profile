    ...
    <nav class="navbar navbar-expand align-items-center gap-4">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <img src="{{asset('assets5/images/gallery/primamandiri1.png')}}" class="rounded-circle p-1 border" width="45" height="45" alt="">
          </a>
          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            <a class="dropdown-item  gap-2 py-2" href="javascript:;">
              <div class="text-center">
              <img src="{{asset('assets5/images/gallery/primamandiri1.png')}}" class="rounded-circle p-1 shadow mb-3" width="90" height="90"
                  alt="">
